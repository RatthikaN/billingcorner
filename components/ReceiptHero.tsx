  ...
  return (
    <section ref={containerRef} className="relative min-h-[150vh] pt-20 pb-0 px-6 overflow-visible">
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        <div className="absolute top-0 right-0 w-64 h-64 md:w-[500px] md:h-[500px] bg-indigo-50/50 rounded-full blur-[80px] md:blur-[120px]" />
        <div className="absolute bottom-0 left-10 w-64 h-64 md:w-[400px] md:h-[400px] bg-primary/5 rounded-full blur-[80px] md:blur-[100px]" />
      </div>
    </section>
  );
}

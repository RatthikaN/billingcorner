...
export default function SmartRackInventory() {
  return (
    <section className="py-24 px-6 bg-white relative z-10 overflow-hidden font-sans">
        ...
        <div className="flex flex-col md:flex-row items-center gap-16 md:gap-24">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-medium text-slate-900 tracking-tight leading-tight mb-6">
              Smart Rack-wise Inventory Control
            </h2>
            <p className="text-slate-600 text-base md:text-lg leading-relaxed font-medium mb-8">
              Track items by their exact rack location for better visibility and control. Simplify warehouse operations with quick item access, accurate stock data, and seamless pick list generation.
            </p>

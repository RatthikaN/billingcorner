    ...
    >
      <div className="sticky top-0 h-screen overflow-hidden bg-slate-900">
        ...
        <motion.div
          ...
          className="absolute bottom-6 right-6 md:bottom-10 md:right-12 z-30 flex items-center gap-4 text-white/40"
        >
...
function SlidePanel({ slide, index, scrollProgress, total, windowWidth }: any) {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-10 grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 lg:gap-24 items-center pt-24 lg:pt-20">
        ...
        >
          ...
          <h3 className="text-3xl md:text-5xl lg:text-6xl font-bold text-white mb-4 md:mb-6 leading-[1.1] tracking-tight">
            {slide.title}
          </h3>

          <p className="text-slate-400 text-base md:text-lg lg:text-xl leading-relaxed max-w-xl font-light">
            {slide.description}
          </p>

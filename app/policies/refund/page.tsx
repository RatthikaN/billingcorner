  ...
  return (
    <div className="max-w-4xl mx-auto py-24 px-6 font-sans">
      ...
      <div className="prose prose-slate max-w-none space-y-6 text-slate-700">
        ...
        <section>
          <h2 className="text-2xl font-bold text-slate-800 mb-4">1. Subscription Cancellations</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold text-slate-800 mb-4">2. Refund Eligibility</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold text-slate-800 mb-4">3. Non-Refundable Items</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold text-slate-800 mb-4">4. Process for Refunds</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold text-slate-800 mb-4">5. Plan Downgrades</h2>
